...
class 뱀게임_클래스():
    ...
    def 게임_구동(self):
        ...
        #경계선 그리기.
        self.게임.draw.line(self.화면, (0,255,0), \
                                    [0,200], [200,200],5)
        self.게임.draw.line(self.화면, (0,255,0), \
                                    [200,0], [200,200],5)
        #self.제어_그리기()
...
while True :
    ...
    for i in range(뉴런.입력개수):
        뱀게임.게임.draw.circle(뱀게임.화면, (0,255,0),(700,200+i*30),10,2)
    for i in range(뉴런.뉴런개수):
        뱀게임.게임.draw.circle(뱀게임.화면, (0,255,0),(800,200+i*30),10,2)
    for i in range(뉴런.뉴런개수):
        뱀게임.게임.draw.circle(뱀게임.화면, (0,255,0),(900,200+i*30),10,2)
    for i in range(뉴런.뉴런개수):
        뱀게임.게임.draw.circle(뱀게임.화면, (0,255,0),(1000,200+i*30),10,2)
    for i in range(뉴런.출력개수):
        뱀게임.게임.draw.circle(뱀게임.화면, (0,255,0),(1100,200+i*30),10,2)
